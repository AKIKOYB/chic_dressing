...
if ( is_home() ) {
	...
	<div id="chic-products"  class="boxed-wrapper clear-fix">
		...
		?>
		<p class="text-center"><a class="chic-bouton" href="http://localhost/chic_dressing/shop/">Voir toute la collection</a></p>
	</div>
	...
	<div id="chic-fashionweek-map" class="boxed-wrapper clear-fix" style="margin-top:30px">
		...
		<iframe src="https://www.google.com/maps/d/embed?mid=1SU-W19k76UkTXASeT7PnGAyDYCY&hl=en_US&ehbc=2E312F" title="La FashionMap" width="100%" height="480"></iframe>';
	</div>
	<?php
